function [partition_i_inter, partition_j_inter, image_i_inter, image_j_inter, partition_i_intra, partition_j_intra] = ...
    co_clustering_global_hierarchy_optical_flow( sequence_name, idx_j, I_i, I_j, seg_i, seg_j, ucm_i, ucm_j, merging_sequence_i, merging_sequence_j, vectors_i, vectors_j, lambda, window_similarities, w_color, w_hog, w_sift, hierarchical_constraint_opt  )
