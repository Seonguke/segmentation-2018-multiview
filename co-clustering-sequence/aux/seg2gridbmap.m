...
%
% Create the boundary map of the segmentation in the contour grid. See
% tests for examples.
% ------------------------------------------------------------------------
% INPUTS
...
%	idx_neighbors   Matrixes containing the indices of the neighboring
%	                regions to that contour
%	junctions       Structure containing the junctions and region labels
%                 	that meet at that junction
% ------------------------------------------------------------------------
%  Copyright (C)
