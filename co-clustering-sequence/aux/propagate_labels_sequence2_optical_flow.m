function [ partitions_vector_out, images_vector_out, last_label ] = propagate_labels_sequence2_optical_flow( sequence_name, idx_new, coarse_partition_i, coarse_partition_j, I_i, I_j, I_new, fine_partition_j, fine_partition_new, ucm_j, ucm_new, merging_sequence_j, merging_sequence_new, vectors_i, vectors_j, vectors_new, window_similarities, w_color, w_hog, w_sift, hierarchical_constraint_opt, num_clusters, last_label )
