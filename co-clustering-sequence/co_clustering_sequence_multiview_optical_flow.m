function co_clustering_sequence_multiview_optical_flow(sequence_name, out_path, num_regions)
...
if ~exist(path_ima)
    ...
    for ii=3:numel(frames)
        ...
        [ partitions_vector_out, images_vector_out, last_label ] = propagate_labels_sequence2_optical_flow(sequence_name, ii, partition_i_inter, partition_j_inter, I_i, I_j, I_new, seg_j, seg_new, ucm_j, ucm_new, merging_sequence_j, merging_sequence_new, vectors_i, vectors_j, vectors_new, window, w_color, w_hog, w_sift, hierarchical_constraint_opt, 2*num_regions, last_label);
