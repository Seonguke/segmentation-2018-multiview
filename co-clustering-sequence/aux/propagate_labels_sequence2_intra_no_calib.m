function [ partitions_vector_out ] = propagate_labels_sequence2_intra_no_calib( coarse_partition_i, coarse_partition_j, I_i, I_j, I_new, fine_partition_j, fine_partition_new, ucm_j, ucm_new, merging_sequence_j, merging_sequence_new, vectors_i, vectors_j, vectors_new, window_similarities, w_color, w_hog, w_sift, pixel_based_MV, hierarchical_constraint_MV, hierarchical_constraint_opt, motion_estimation, num_clusters )
