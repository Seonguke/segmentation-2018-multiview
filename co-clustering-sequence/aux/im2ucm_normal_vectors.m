function [ucm2, ws_a, leaves_partition, merging_sequence] = im2ucm_normal_vectors(img_file, ucm_file, bpt_file, leaves_part_file) %#ok<STOUT>
...
evalc('[ucm2, ws_a] = contours2ucm_normal_vectors(gPb_orient, ''doubleSize'')');
